...
for j=1:N_prog
	...
	for i=1:n
		if(rhel(i) > r_min && rhel(i) < r_max && tan_vel(i) < tan_vel_max)	%only plot particles within these spatial ranges
			rad(end+1) = rhel(i); 
...
print(21,strcat("C:/Users/dpryd/Desktop/streamFind/Aquarius_plots_final/",filename,"_tanV_filtered.png"),"-dpng")
